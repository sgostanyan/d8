...
namespace Drupal\d8_account_settings_form\Form;
...
/**
 * Class AlteredAccountSettingsForm
 *
 * @package Drupal\d8_account_settings_form\Form
 */
class AlteredAccountSettingsForm extends AccountSettingsForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['custom_section'] = [
      ...
      '#description' => $this->t('Custom section'),
      '#group' => 'email',
    ];
    $form['custom_section']['settings']['custom_body'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Body'),
      '#default_value' => $mail_config->get('custom_section.body'),
      '#rows' => 3,
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('user.mail')
      ...
      ->set('custom_section.body', $form_state->getValue('custom_body'))
      ->save();
