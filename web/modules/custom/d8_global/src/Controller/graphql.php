...
GRAPHQL;
   ...
   $result =  $this->graphql_query('https://graphqlzero.almansi.me/api', $query, ['id' => 1], null);
  ...
  public function graphql_query(string $endpoint, string $query, array $variables = [], string $token = null) {
    $headers = [
