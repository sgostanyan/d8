...
use Drupal\d8_api\Service\ApiTariferService;
 ...
 */
class TariferForm extends FormBase {

  /**
   * @var \Drupal\d8_api\Service\ApiTariferService
   */
   ...
   * Class constructor.
   *
   * @param \Drupal\d8_api\Service\ApiTariferService $apiTarifer
   */
  ...
  public static function create(ContainerInterface $container) {
    return new static($container->get('d8_api.api_tarifer'));
  }
