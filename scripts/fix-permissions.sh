...
Example: (sudo) bash ${0##*/} --drupal_root_project_path=/usr/local/apache2/htdocs --drupal_web_path=/usr/local/apache2/htdocs/web --drupal_user=john --httpd_group=www-data
HELP
exit 0
}
